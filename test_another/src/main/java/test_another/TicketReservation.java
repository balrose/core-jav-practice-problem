/*
 * package test_another; import java.util.ArrayDeque; import
 * java.util.ArrayList; import java.util.Deque; import java.util.Iterator;
 * import java.util.List;
 * 
 * public class TicketReservation {
 * 
 * 
 * private static final int CONFIRMEDLIST_LIMIT = 10; private static final int
 * WAITINGLIST_LIMIT = 3;
 * 
 * private List<Passenger> confirmedList = new ArrayList<>(); private
 * Deque<Passenger> waitingList = new ArrayDeque<>();
 * 
 * // This getter is used only by the junit test case. public List<Passenger>
 * getConfirmedList() { return confirmedList; }
 * 
 *//**
 ...
 * 
 * 
 * public boolean bookFlight(String firstName, String lastName, int age, String
 * gender, String travelClass, String confirmationNumber) {
 * 
 * }
 * 
 *//**
 ...
 *//**
	 ...
	 *//*
		 * public boolean removePassenger(Iterator<Passenger> iterator, String
		 * confirmationNumber) {
		 * 
		 * }
		 * 
